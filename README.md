...
3. 本リポジトリに公開している[インポート用のファイル(Zipファイル)](https://github.com/City-of-Kobe/pva-aoai-integration-solution/releases)をダウンロード
4. Power Apps を開く  
...
9. インポートにより、32つのオブジェクトがインポートされたことを確認  
※ 内訳は、クラウドフロー、チャットボット、テーブルがそれぞれ1つ、チャットボットサブコンポーネントが26つ、環境変数が2つ、接続設定が1つ
